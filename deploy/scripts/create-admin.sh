...
#
# Chỉ là lớp vỏ mỏng: toàn bộ việc thật nằm ở api/cmd/create-admin (Go), vì mật khẩu
...
[[ -f "$APP_DIR/api/.env" ]] || chet "Chưa có $APP_DIR/api/.env — chạy 02-deploy.sh trước."
