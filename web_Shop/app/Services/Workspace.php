...
/**
 * Workspace — những KHU người đang đăng nhập mở được: `quan_ly`, `thu_ngan`, hoặc cả hai.
 *
 ...
 *
 * Nên cửa phải được LÀM MỚI, không phải nhớ một lần. Cùng lối với SubscriptionExpiry:
...
class Workspace
{
     ...
     *
     * 60 giây, cùng con số với SubscriptionExpiry và cùng lý do: đủ thưa để không thành một
