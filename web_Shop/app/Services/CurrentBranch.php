...
/**
 * CurrentBranch — danh sách chi nhánh cho ô chọn ở thanh trên cùng.
 *
...
class CurrentBranch
{
    ...
    /**
     * Quên bản nhớ — gọi ở ĐẦU MỖI REQUEST (BranchPerTab).
     *
    ...
    {
        $congTy = \App\Http\Controllers\BranchController::LOAI_CONG_TY;
