...
class WorkspaceModule
{
    ...
    {
        $cua = \App\Http\Middleware\EnsureWorkspace::cuaCuaPhien();
    ...
    public static function danhSach(): array
    {
        ...
        //
        // Workspace đã lo đường lui cho phiên cũ (suy từ vai trò), nên tới đây mà rỗng
        // thì nghĩa là người này thật sự không có khu nào để đổi sang.
        $cua = \App\Services\Workspace::cua();
    ...
    protected static function tatCa(): array
    {
        return [
            [
                ...
                'anh' => 'images/admin-workspace.jpg',
            ...
            [
                ...
                'anh' => 'images/cashier-workspace.jpg',
