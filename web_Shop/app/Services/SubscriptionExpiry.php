...
/**
 * SubscriptionExpiry — hạn hợp đồng phần mềm của cửa hàng đang đăng nhập, giữ trong session.
 *
 ...
 *   - middleware LockWhenExpired (làm mới định kỳ khi người dùng đi lại trong app);
