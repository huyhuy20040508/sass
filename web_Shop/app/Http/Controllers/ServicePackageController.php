...
/**
 * ServicePackageController — trang "Các gói dịch vụ" của khu quản trị.
 *
...
class ServicePackageController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            if ($res->successful()) {
                ...
                // quét nền của máy chủ. Xem SubscriptionExpiry.
                SubscriptionExpiry::ghiNhan($hopDong);
        ...
        $view = view('subscription.index', compact('hopDong', 'bangGia', 'fields', 'daDung'));
    ...
    public function thanhToan(int $id)
    {
        ...
        // làm mới định kỳ mới dùng lại được phần mềm (xem SubscriptionExpiry).
        if (! empty($don['da_tra'])) {
            SubscriptionExpiry::quen();
        }

        $view = view('subscription.thanh-toan', ['don' => $don, 'id' => $id]);
