...
class ParameterController extends Controller
{
    ...
    {
        return redirect()->route('admin.thong-so-chung.numbering-rule');
    }
    ...
    public function quyTacDanhSo()
    {
        ...
        $view = view('parameters.numbering-rule', [
            'page' => 'numbering-rule',
            'meta' => self::PAGES['numbering-rule'],
            'chiNhanh' => $chiNhanh,
            'loai' => $loai,
    ...
    public function luuQuyTacDanhSo(Request $request)
    {
        ...
        if ($res->successful()) {
            return redirect()
                ->route('admin.thong-so-chung.numbering-rule', ['cn' => $du['shop_id']])
