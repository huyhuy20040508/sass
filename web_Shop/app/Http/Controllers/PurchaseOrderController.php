...
class PurchaseOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $view = view('v2::purchase-orders.index', [
     ...
     * ngày, và cột nào cũng là chữ nên không cộng được. Xem App\Support\XlsxOrder
    ...
    {
        // Cùng bộ luật với SupplierController::duLieu — hộp thoại là một, thì
        ...
        // của v2 — đổi tên ở đúng một chỗ, như SupplierController vẫn làm.
        $o['is_active'] = (int) ($o['status'] ?? SupplierController::DANG_HOP_TAC) === SupplierController::DANG_HOP_TAC;
        unset($o['status']);
