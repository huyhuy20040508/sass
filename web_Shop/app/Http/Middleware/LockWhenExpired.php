...
class LockWhenExpired
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (! SubscriptionExpiry::daKhoa() || $laTrangGoi) {
            return $next($request);
        }
    ...
    {
        if (! SubscriptionExpiry::nenHoiLai()) {
            return;
        }
        ...
        try {
            ...
            if ($res->successful()) {
                SubscriptionExpiry::ghiNhan($res->json('data.hop_dong'));
            }
        } catch (\Throwable $e) {
