...
@section('title', \App\Http\Controllers\SupplierReturnController::TITLE_PAGE)

@section('content')
    {{-- Tên ô của form = tên trường bên API nên controller gửi thẳng payload đi. --}}
    @php
        $C = \App\Http\Controllers\SupplierReturnController::class;
        $TITLE = $C::TITLE_PAGE;
    ...
    <script>
        (function () {
            ...
            const NHAN_TRANG_THAI = @json(\App\Http\Controllers\SupplierReturnController::TRANG_THAI);
            const MAU_TRANG_THAI = @json(\App\Http\Controllers\SupplierReturnController::MAU_TRANG_THAI);
            const NHAN_KHO = @json(\App\Http\Controllers\SupplierReturnController::TRANG_THAI_KHO);
            const MAU_KHO = @json(\App\Http\Controllers\SupplierReturnController::MAU_TRANG_THAI_KHO);
            const LOAI_CT = @json(\App\Http\Controllers\SupplierReturnController::LOAI_CHUNG_TU);
            ...
            // xong gọi tiếp đường duyệt (xem SupplierReturnController::store).
