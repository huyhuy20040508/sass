...
@section('title', \App\Http\Controllers\LocationController::TITLE_PAGE)
...
@section('content')
    ...
    --}}
    @php
        $C = \App\Http\Controllers\LocationController::class;
        $TITLE = $C::TITLE_PAGE;
    ...
    <div class="vt">
        ...
        @include('partials.pagination-v2', [
            'meta' => $meta,
            'noun' => 'vị trí',
            'perPageOptions' => \App\Http\Controllers\LocationController::MUC_SO_DONG,
        ])
    </div>
