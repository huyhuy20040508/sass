        ...
        <tbody>
            @foreach($danhMuc as $k => $khu)
                @php
                    ...
                    $khuKhoa = $chiQuay && ($khu['ma'] ?? '') !== \App\Services\Workspace::THU_NGAN;
                @endphp
                        ...
                        <tr @class(['pq-row', 'is-hidden', 'is-khoa' => $khuKhoa])
                            ...
                            @foreach($viec as $ma => $nhan)
                                <td class="pq-col-viec">
                                    @if(in_array($ma, $coViec, true))
                                        ...
                                        @include('permissions.partials.keep-locked-permission', ['khoa' => $khuKhoa, 'bat' => $bat, 'maGiu' => $maQ])
                                    @endif
                                </td>
                            @endforeach
                            ...
                            <td class="pq-col-le">
                                @foreach($muc['le'] ?? [] as $le)
                                    ...
                                    @include('permissions.partials.keep-locked-permission', ['khoa' => $khuKhoa, 'bat' => $bat, 'maGiu' => $maLe])
                                @endforeach
                            </td>
                        </tr>
                    @endforeach
