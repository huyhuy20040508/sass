...
@section('title', \App\Http\Controllers\PermissionController::TITLE)
...
@section('content')
    ...
    @php
        $C = \App\Http\Controllers\PermissionController::class;
                    ...
                    @forelse($chiNhanh as $cn)
                        ...
                        <div class="pq-branch {{ $mo ? 'is-open' : '' }}">
                            ...
                            <div class="pq-branch-emps">
                                @forelse($ds as $nv)
                                    @include('permissions.partials.employee', ['nv' => $nv, 'chon' => $chon])
                                @empty
                ...
                @else
                    ...
                    @if(! $coTaiKhoan)
                        <p class="pq-callout is-info">
                            ...
                            Cấp tài khoản trong hồ sơ ở <a href="{{ route('admin.staff.index') }}">Nhân sự</a> rồi quay lại đây.
                        </p>
                    @elseif($laChinhMinh)
                    ...
                    @if($coTaiKhoan && $chiQuay)
                        <p class="pq-callout is-info">
                            ...
                            <a href="{{ route('admin.staff.index') }}">hồ sơ Nhân sự</a> trước, rồi quay lại đây.
                        </p>
                    @endif
                    ...
                    @if($coTaiKhoan && !empty($danhMuc))
                        <form method="POST" action="{{ route('admin.phan-quyen.datQuyenNhanVien', $userId) }}"
                            ...
                            @include('permissions.partials.matrix', ['chiDoc' => ! $suaDuoc])
                        </form>
    ...
    @include('permissions.partials.style')
