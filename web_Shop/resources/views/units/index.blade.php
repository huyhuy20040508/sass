...
@section('title', \App\Http\Controllers\UnitController::TITLE_PAGE)
...
@section('content')
    ...
    --}}
    @php
        $C = \App\Http\Controllers\UnitController::class;
        $TITLE = $C::TITLE_PAGE;
    ...
    <div class="dvt">
        ...
        @include('partials.pagination-v2', [
            'meta' => $meta,
            'noun' => 'đơn vị',
            'perPageOptions' => \App\Http\Controllers\UnitController::MUC_SO_DONG,
        ])
    </div>
