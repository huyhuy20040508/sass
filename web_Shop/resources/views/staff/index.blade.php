...
@section('content')
    ...
    <div class="nsu">
        ...
        <form method="GET" action="{{ route('admin.staff.index') }}" id="nsuFilter" class="nsu-filter">
            <div class="nsu-toolbar">
                ...
                @if($hasFilter)
                    <a href="{{ route('admin.staff.index') }}" class="nsu-clear">Xoá lọc</a>
                @endif
                ...
                <div class="nsu-toolbar-actions">
                    ...
                    <a href="{{ route('admin.staff.export', array_filter($filters, fn ($v) => $v !== '' && $v !== 0)) }}"
                       class="nsu-btn-ghost">
        ...
        <form method="POST" id="nsuBulkForm" action="{{ route('admin.staff.bulkDestroy') }}">
            @csrf
                    ...
                    @forelse($list as $i => $ns)
                        ...
                        <tr>
                            ...
                            <td class="nsu-c-status">
                                ...
                                <form method="POST" action="{{ route('admin.staff.updateStatus', $ns['id']) }}"
                            ...
                            <td class="nsu-c-act">
                                <div class="nsu-actions">
                                    ...
                                    <form method="POST" action="{{ route('admin.staff.destroy', $ns['id']) }}"
        ...
        @include('partials.pagination-v2', [
            'meta' => $meta,
            'noun' => 'người',
            'perPageOptions' => \App\Http\Controllers\StaffController::MUC_SO_DONG,
        ])
    </div>
    ...
    <div class="nsu-overlay" id="nsuOverlay" style="display:none;">
        <div class="nsu-dialog">
            ...
            <form id="nsuForm" method="POST" action="{{ route('admin.staff.store') }}">
                @csrf
    ...
    <script src="{{ asset('js/staff-rule.js') }}"></script>
    ...
    <script>
        (function () {
            ...
            // Chỗ quy đổi nằm ở controller (StaffController::vaiTro), một chỗ duy nhất.
            ...
            var DUONG_ANH = @json(route('admin.staff.anh'));
            ...
            function dongBoCaLam() {
                // Luật nằm ở public/js/staff-rule.js — chỗ node --test chạy tới
            ...
            var XOA_HANG_LOAT = @json(route('admin.staff.bulkDestroy'));
            var TRANG_THAI_HANG_LOAT = @json(route('admin.staff.bulkTrangThai'));
