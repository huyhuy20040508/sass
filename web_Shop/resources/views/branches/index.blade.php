...
@section('content')
                        ...
                        <section class="cn-col">
                            ...
                            <div>
                                ...
                                <p class="cn-hint" id="cnMaHint">
                                    ...
                                    <a href="{{ route('admin.thong-so-chung.numbering-rule') }}" target="_blank" rel="noopener">quy tắc đánh số</a>
    ...
    <script>
        (function () {
            ...
            // ---------- Tiện ích chung ----------
            var LOAI = @json(\App\Http\Controllers\BranchController::LOAI);
            ...
            var NHA_CC = @json(\App\Http\Controllers\BranchController::NHA_CUNG_CAP_ETAX);
