...
@section('title', \App\Http\Controllers\ServicePackageController::TITLE)
...
@section('content')
    ...
    --}}
    @php
        $support = \App\Http\Controllers\ServicePackageController::SUPPORT_EMAIL;
        ...
        // LockWhenExpired và, bên Go, choPhepKhiCuaHangKhoa).
        //
        ...
        $khoa = \App\Services\SubscriptionExpiry::daKhoa() || $quaHan;
    ...
    <div class="gdv">
        ...
        <div class="gdv-head">
            <div class="gdv-head-text">
                <h1 class="gdv-title">{{ \App\Http\Controllers\ServicePackageController::TITLE }}</h1>
