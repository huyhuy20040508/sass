...
@section('title', \App\Http\Controllers\PurchaseOrderController::TITLE_PAGE)
...
@section('content')
    ...
    @include('partials.modal-supplier')
    ...
    <script>
        (function () {
            ...
            const MAU_TRANG_THAI = @json(\App\Http\Controllers\PurchaseOrderController::MAU_TRANG_THAI);
            const NHAN_TRA = @json(\App\Http\Controllers\PurchaseOrderController::TRANG_THAI_TRA);
            const MAU_TRA = @json(\App\Http\Controllers\PurchaseOrderController::MAU_TRANG_THAI_TRA);
            ...
            // xong gọi tiếp đường duyệt (xem PurchaseOrderController::store).
