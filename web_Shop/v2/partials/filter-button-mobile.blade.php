{{-- Nút mở khối lọc trên điện thoại — chép nguyên components/filter-button-mobile của v2.
     Nhận: $dataBsTarget (id offcanvas), $dataOffcanvasTarget (id khối lọc), $modalLabel. --}}
<div class="btn-open-modal" type="button" data-bs-toggle="offcanvas" data-bs-target="{{ '#' . $dataBsTarget }}"
    aria-controls="{{ $dataBsTarget }}" data-offcanvas-target="{{ '#' . $dataOffcanvasTarget }}">
    <p class="open-modal-label">
        {{ $modalLabel }}
    </p>
    <div class="icon-for-cta">
