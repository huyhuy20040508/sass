{{-- Màn Trả hàng nhà cung cấp dựng theo khuôn v2 (purchase/supplier-return-order:
     ...
     Dữ liệu do SupplierReturnController đẩy sang: $list, $filters, $meta,
...
@php
    ...
    $hasFilter = collect($filters)->only(['keyword', 'status', 'supplier_id', 'from_date', 'to_date'])
                ...
                <div class="list scrollDiv">
                    <div class="table-responsive table-border-style">
                        <table class="table-return none_mobile">
                            ...
                            @empty
                                <tr>
                                    <td colspan="14" class="text-center py-4">{{ $hasFilter ? 'Không có phiếu trả hàng nào khớp bộ lọc đang bật.' : $C::EMPTY_TEXT }}</td>
                                </tr>
                            @endforelse
                        </table>
...
@push('scripts')
    <script>
        ...
        function locLai() {
            ...
            // vẫn chỉ có tháng này — xem SupplierReturnController::filters.
