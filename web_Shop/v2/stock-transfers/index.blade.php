{{-- Màn Phiếu điều chuyển dựng theo khuôn v2 (purchase/transfer-slip:
     ...
     Dữ liệu do StockTransferController đẩy sang: $list, $filters, $meta,
     $chiNhanh, $nhanVien, $chiNhanhDangLam. --}}
@extends('v2::layouts.master')

@section('title', \App\Http\Controllers\StockTransferController::TITLE_PAGE)

@php
    $C = \App\Http\Controllers\StockTransferController::class;
...
@push('scripts')
    <script>
        ...
        const NHAN_TRANG_THAI = @json(\App\Http\Controllers\StockTransferController::TRANG_THAI);
        const LOAI_GIAO_DICH = @json(\App\Http\Controllers\StockTransferController::LOAI_GIAO_DICH);
        ...
        function locLai() {
            ...
            // vẫn chỉ có tháng này — xem StockTransferController::filters.
