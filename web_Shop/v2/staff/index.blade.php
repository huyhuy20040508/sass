{{-- Màn Nhân sự dựng theo khuôn v2 (hrm/employee/index + list).
     Dữ liệu do StaffController đẩy sang: $list, $filters, $meta, $chiNhanh, $quyen. --}}
            ...
            <div class="fillter-box">
                <div class="card">
                    ...
                    <div class="card-body px-2">
                        ...
                        <form action="{{ route('admin.staff.index') }}" method="GET" id="search-form">
...
@push('scripts')
    ...
    <script>
        ...
        const URL_STORE = @json(route('admin.staff.store'));
        const URL_BULK_DEL = @json(route('admin.staff.bulkDestroy'));
        const URL_ANH = @json(route('admin.staff.anh'));
        const URL_EXPORT = @json(route('admin.staff.export'));
