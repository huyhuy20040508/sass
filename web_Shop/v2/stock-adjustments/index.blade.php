...
@section('title', \App\Http\Controllers\StockAdjustmentController::TITLE)

@php
    $C = \App\Http\Controllers\StockAdjustmentController::class;
...
@push('scripts')
    <script>
        ...
        const LO_KHONG_XAC_DINH = @json(\App\Http\Controllers\StockAdjustmentController::LO_KHONG_XAC_DINH);
        const NHAN_TRANG_THAI = @json(\App\Http\Controllers\StockAdjustmentController::TRANG_THAI);
        const NHAN_KHO = @json(\App\Http\Controllers\StockAdjustmentController::TRANG_THAI_KHO);
        const NHAN_DONG = @json(\App\Http\Controllers\StockAdjustmentController::TRANG_THAI_DONG);
