{{-- Màn Phiếu mua hàng dựng theo khuôn v2 (purchase/order: index + list + create).
     Dữ liệu do PurchaseOrderController đẩy sang: $list, $filters, $meta, $thongKe,
     $nhaCungCap, $nhanVien, $nhomHang. --}}
@extends('v2::layouts.master')

@section('title', \App\Http\Controllers\PurchaseOrderController::TITLE)

@php
    $C = \App\Http\Controllers\PurchaseOrderController::class;
...
@push('scripts')
    <script>
        ...
        const NHAN_TRANG_THAI = @json(\App\Http\Controllers\PurchaseOrderController::TRANG_THAI);
        const CHU_TRANG_THAI = @json(\App\Http\Controllers\PurchaseOrderController::CHU_TRANG_THAI);
        const NHAN_TRA = @json(\App\Http\Controllers\PurchaseOrderController::TRANG_THAI_TRA);
        const CHU_TRA = @json(\App\Http\Controllers\PurchaseOrderController::CHU_TRANG_THAI_TRA);
        ...
        function locLai() {
            ...
            // xong bảng vẫn chỉ có tháng này — xem PurchaseOrderController::filters.
        ...
        // tiếp đường duyệt (xem PurchaseOrderController::store).
        ...
        // từ CDN về. Máy chủ đã có XlsxOrder dựng bằng ZipArchive sẵn có của PHP,
