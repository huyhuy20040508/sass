{{-- Màn Quản lý thu chi — chép khuôn từ bản v2 cũ
     ...
     - Nhãn lọc nguồn phát sinh nói đúng cái nó lọc (xem CashbookController::NGUON). --}}
@extends('v2::layouts.master')

@section('title', \App\Http\Controllers\CashbookController::TITLE_PAGE)

@php
    $C = \App\Http\Controllers\CashbookController::class;
                ...
                <div class="card">
                    ...
                    <div class="card-body px-2">
                        ...
                        {{-- CHI NHÁNH.
                             ...
                             nhánh từ `chi_nhanh` (xem middleware BranchPerTab).
                    ...
                    <div class="justify-content-end">
                        <div class="btn_top_content d-flex align-items-center">
                            ...
                            <a class="btn btn-sm d-flex align-items-center btn-export"
                                href="{{ route('admin.cashbook.export', request()->query()) }}">
...
@push('scripts')
    <script>
        ...
        const URL_TC_STORE = @json(route('admin.cashbook.store'));
        const URL_TC_PHAN_LOAI = @json(route('admin.cashbook.phanLoai'));
        const URL_TC_NGUOI_NOP = @json(route('admin.cashbook.nguoiNop'));
        const URL_TC_TAO_NGUOI_NOP = @json(route('admin.cashbook.taoNguoiNop'));
        const URL_TC_XOA_NGUOI_NOP = @json(url('admin/cashbook/entries/payers'));
        const URL_TC_DINH_KEM = @json(route('admin.cashbook.dinhKem'));
        ...
        const VAI_NHAN_VIEN = @json(\App\Http\Controllers\CashbookController::DOI_TUONG_NHAN_VIEN);
