...
@section('title', \App\Http\Controllers\CashbookCategoryController::TITLE_PAGE)

@php
    $C = \App\Http\Controllers\CashbookCategoryController::class;
@endphp
