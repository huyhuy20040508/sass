{{-- Màn Công nợ — chép khuôn từ bản v2 cũ
     ...
     TÁM CHỖ CỐ Ý KHÁC V2 — xem thêm đầu DebtController:
...
@section('title', \App\Http\Controllers\DebtController::TITLE_PAGE)

@php
    $C = \App\Http\Controllers\DebtController::class;
    ...
    // Hai mục chứ không ba — xem DebtController::TRANG_THAI_LOC.
                ...
                <div class="card">
                    ...
                    <div class="card-body px-2">
                        ...
                        {{-- CHI NHÁNH.
                             ...
                             đều lấy chi nhánh từ `chi_nhanh` (middleware BranchPerTab). --}}
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="payment-method">
                                @foreach (\App\Http\Controllers\DebtController::PHUONG_THUC as $ma => $ten)
...
@push('scripts')
    <script>
        ...
        const CHU = {
            cash: @json(\App\Http\Controllers\DebtController::PHUONG_THUC['cash']),
            transfer: @json(\App\Http\Controllers\DebtController::PHUONG_THUC['transfer']),
