 ...
 */
class NumberingRuleTest extends TestCase
{
        ...
        Http::fake([
            ...
            '*/admin/quy-tac-ma*' => Http::response(['data' => [
                'loai' => [
                    ...
                    ['ma' => 'employee', 'ten' => 'Nhân viên', 'dung_chung' => true, 'bat_tat_duoc' => true, 'tien_to_goi_y' => 'NV'],
                ...
                'quy_tac' => [
                    ...
                    ['shop_id' => 0, 'doc_type' => 'employee', 'prefix' => 'NV', 'value_part' => 'so-thu-tu', 'length' => 4, 'suffix' => '', 'is_active' => false],
    ...
    public function test_danh_muc_tat_thi_an_dong_va_khoa_o_nhap(): void
    {
        ...
        $this->assertMatchesRegularExpression('/data-loai="employee"[^>]*\bhidden\b/', $html);
        $this->assertMatchesRegularExpression('/data-tick="hang-hoa"\s+checked/', $html);
        $this->assertDoesNotMatchRegularExpression('/data-tick="employee"\s+checked/', $html);
    }
