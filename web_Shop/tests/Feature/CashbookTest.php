...
class CashbookTest extends TestCase
{
     ...
     *
     * Xoá luôn bộ nhớ static của CurrentBranch: service nhớ kết quả cho cả
    ...
    protected function haiChiNhanh(): void
    {
        ...
        \App\Services\CurrentBranch::quenCache();
    }
    ...
    public function test_phieu_bi_khoa_khong_co_nut_sua_xoa(): void
    {
        ...
        $html = $this->withSession($this->phien())->get(route('admin.cashbook.index'))
            ->assertOk()
            ->getContent();
    ...
    public function test_so_tu_mot_ty_rut_gon(): void
    {
        ...
        $this->withSession($this->phien())->get(route('admin.cashbook.index'))
            ->assertOk()
            ->assertSee('~ 2,5 tỷ');
    }
    ...
    public function test_ngay_gui_rong_thi_khong_tu_dien_thang_nay(): void
    {
        ...
        $this->withSession($this->phien())
            ->get(route('admin.cashbook.index', ['from_date' => '', 'to_date' => '']))
            ->assertOk();
    ...
    public function test_khong_gui_ngay_thi_lay_thang_nay(): void
    {
        ...
        $this->withSession($this->phien())->get(route('admin.cashbook.index'))->assertOk();
     ...
     *
     * Chi nhánh đang làm việc đi qua `chi_nhanh` (middleware BranchPerTab) và
    ...
    public function test_dinh_kem_chan_tep_la(): void
    {
        ...
        $this->withSession($this->phien())
            ->postJson(route('admin.cashbook.dinhKem'), [
    ...
    public function test_loc_nguon_gan_gia_tri_la(): void
    {
        ...
        $this->withSession($this->phien())
            ->get(route('admin.cashbook.index', ['source' => 'order,linh-tinh,purchase']))
            ->assertOk();
    ...
    public function test_so_tien_khong_duong_bi_chan(): void
    {
        ...
        $this->withSession($this->phien())
            ->postJson(route('admin.cashbook.store'), [
                'type' => 0,
                'amount' => 0,
                'payment_method' => 'cash',
            ])
    ...
    public function test_ma_loi_giu_theo_api(): void
    {
        ...
        $this->withSession($this->phien())
            ->deleteJson(route('admin.cashbook.destroy', 99))
            ->assertStatus(404)
    ...
    public function test_tat_cot_qua_query(): void
    {
        ...
        $html = $this->withSession($this->phien())
            ->get(route('admin.cashbook.index', ['hide' => 'note,branch']))
            ->assertOk()
            ->getContent();
