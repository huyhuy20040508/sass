...
/**
 * CustomerOrderController — khu "QLTK khách hàng order" của khu điều hành.
 *
...
class CustomerOrderController extends Controller
{
     ...
     * `cmd/create-admin`: lệch nhau thì cửa hàng tạo ở đây không đăng nhập được bên
     * Shop Admin.
     */
     ...
     *
     * Ba quy tắc định dạng dưới đây phải khớp Go và `cmd/create-admin`, y như bên
     ...
     *
     * KHÔNG ghi vào sổ thu. Tiền vào là việc riêng (`cmd/subscriptions thu-tien`), và
    ...
    public function goiDichVu()
    {
        ...
        return view('customer-orders.service-packages', [
    ...
    public function tinhNangGoi()
    {
        ...
        return view('customer-orders.package-features', [
            'plans' => data_get($data, 'plans') ?: [],
    ...
    public function database()
    {
        ...
        return view('customer-orders.database', [
    ...
    protected function manHinhHopDong(string $nhom, string $tieuDe, string $moTa, array $them = [])
    {
        ...
        return view('customer-orders.contracts', array_merge([
