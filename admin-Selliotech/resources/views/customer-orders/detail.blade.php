{{--
    ...
    HAI KHỐI, và ranh giới giữa chúng là ranh giới quan trọng nhất của màn hình:
      ...
      · ĐIỀU KHOẢN ĐÃ KÝ (gói · chu kỳ · giá · ba hạn mức · tên miền riêng) —
        ...
        khách là sửa chính hợp đồng của họ, làm bằng `cmd/subscriptions` trên máy chủ
...
@section('content')
    ...
    <div class="row g-3">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <p class="hint" style="margin-top:12px">
                        ...
                        <span class="mono">cmd/subscriptions</span> trên máy chủ.
                    </p>
                </div>
            </section>
        ...
        <div class="col-12 col-lg-7">
            <section class="panel">
                ...
                @else
                    <form method="POST" action="{{ route('platform.customer-orders.contracts.luu', data_get($hd, 'id')) }}">
                        @csrf
                        <div class="panel-body">
                            <div class="grid2">
                                <div class="rong">
    ...
    @if ($sua_duoc)
        ...
        <dialog class="sheet" id="sheet-matkhau" style="width:min(460px,calc(100vw - 32px))"
            ...
            <form method="POST" action="{{ route('platform.customer-orders.contracts.doi-mat-khau', data_get($hd, 'id')) }}">
                @csrf
