...
//	@Description	Bản HTTP của `cmd/subscriptions ky --dung-thu`, khác một điểm: KHÔNG cho khai
...
//	@Description	khai tay. Thoả thuận riêng vẫn đi qua `cmd/subscriptions ky`.
//	@Description	`so_thang` bỏ trống = một chu kỳ của gói (1 tháng, hoặc 12 nếu gói theo năm).
//	@Tags			Platform - Khách hàng
//	@Accept			json
//	@Produce		json
...
//	@Description	của `cmd/subscriptions`.
...
//	@Description	KHÔNG ghi vào sổ thu — tiền vào là `cmd/subscriptions thu-tien`, việc khác.
//	@Tags			Platform - Khách hàng
//	@Accept			json
//	@Produce		json
//	@Security		BearerAuth
