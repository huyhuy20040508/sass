...
//
//	go run ./cmd/create-admin                                      # hỏi từng ô
//	go run ./cmd/create-admin --ma-cua-hang quochuy --ten-dang-nhap admin --mat-khau '...'
//	go run ./cmd/create-admin --ma-cua-hang quochuy --ten-dang-nhap admin --doi-mat-khau
//
